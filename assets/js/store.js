  ...
  return [
    {
      ...
      dateDebut: iso(9),
      client: { nom: 'Dr Marc Dubois', fonction: 'Médecin généraliste · porteur du projet', email: 'm.dubois@msp-caraibes.fr', tel: '0696 00 00 00', indicatif: '596' },
      consultant: { nom: 'ARNOBE Frédéric', email: 'frederic.arnobe@elodiatech.fr' },
      equipe: 9,
      surface: 280,
    ...
    },
    {
      ...
      modeleJuridique: 'sisa',
      dateDebut: iso(5),
      client: { nom: 'Dr Aline Mercier', fonction: 'Médecin généraliste · coordinatrice', email: 'a.mercier@msp-archipel.fr', tel: '0690 00 00 00', indicatif: '590' },
      consultant: { nom: 'ARNOBE Frédéric', email: 'frederic.arnobe@elodiatech.fr' },
      equipe: 6,
      surface: 195,
    ...
    },
    {
      ...
      dateDebut: iso(2),
      client: { nom: 'Mme Sophie Rivière', fonction: 'Directrice · structure gestionnaire', email: 's.riviere@cds-nord.fr', tel: '0696 11 22 33', indicatif: '596' },
      consultant: { nom: 'ARNOBE Frédéric', email: 'frederic.arnobe@elodiatech.fr' },
      equipe: 12,
      surface: 240,
    ...
    },
    {
      ...
      modeleJuridique: 'assoc',
      dateDebut: iso(1),
      client: { nom: 'Dr Paul Anselme', fonction: 'Médecin coordonnateur', email: 'p.anselme@cds-amazonie.fr', tel: '0694 00 00 00', indicatif: '594' },
      consultant: { nom: 'ARNOBE Frédéric', email: 'frederic.arnobe@elodiatech.fr' },
      equipe: 8,
      surface: 310,
      gdocProjetSante: '',
  ...
  return {
    ...
    experts: [
      { id: 'exp1', nom: 'ARNOBE Frédéric', fonction: 'Expert projets de santé · fondateur',
        email: 'frederic.arnobe@elodiatech.fr', tel: '', principal: 'OUI' },
    ],
...
const Store = {
  ...
  ajouterProjet(donnees) {
    ...
    this.commit((s) => {
      ...
      const projet = {
        ...
        dateDebut: debut,
        client: { nom: '', fonction: '', email: '', tel: '', indicatif: INDICATIFS[0].code },
  ...
  _ligneProjet(projet) {
    return {
      ...
      clientIndicatif: projet.client?.indicatif,
